...
def ResnetEncoderTiny(in_channels,blocks_sizes=[24, 32, 48, 64], depths=[2,2,2,2], activation='relu'):
    return ResNetEncoder(in_channels,blocks_sizes=blocks_sizes,depths=depths,activation=activation)
def ResnetEncoderSuperTiny(in_channels,blocks_sizes=[2, 4, 8, 16], depths=[2,2,2,2], activation='relu'):
    return ResNetEncoder(in_channels,blocks_sizes=blocks_sizes,depths=depths,activation=activation)